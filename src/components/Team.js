      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="flex flex-col gap-12 max-w-5xl mx-auto w-full">
          ...
          <TeamProfileCard
            ...
            bio="Leading the vision and strategy for Buildify, ensuring innovative solutions and client satisfaction."
          ...
          <TeamProfileCard
            ...
            bio="Developing intelligent full-stack solutions with advanced machine learning integration for scalable enterprise applications."
